...
test('renders code block content during streaming', async () => {
  ...
  expect(await screen.findAllByText((content, element) => element !== null && element.tagName.toLowerCase() === 'code' && content.includes("console"))).toHaveLength(2);
  expect(await screen.findAllByText((content, element) => element !== null && element.tagName.toLowerCase() === 'code' && content.includes("log"))).toHaveLength(2);
